...
- `mt resources exec -- <command> [args...]`: run with validated recorded allocations, protecting them from release until the command exits. See [resource lifecycle](../../../docs/reference/resources.md) for migration and cleanup behavior.
